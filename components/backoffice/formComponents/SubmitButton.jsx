    ...
    <div className="sm:col-span-1">
      {isLoading ? (
        <button
          disabled
          type="button"
          className="mt-4  text-white bg-blue-500  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium
          opacity-70 rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-slate-500 dark:disabled:hover:bg-slate-500 dark:focus:ring-blue-900 items-center  cursor-not-allowed"
        >
          <svg
            aria-hidden="true"
            role="status"
