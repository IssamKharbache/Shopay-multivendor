  ...
  return (
    ...
    >
      {products.map((product, index) => {
        return (
          <div
            className="rounded-xl bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-800 shadow-lg p-10 flex flex-col items-center gap-2 duration-200 group/img"
            key={index}
          >
            ...
            <button className="rounded-md relative w-36 h-10 cursor-pointer flex items-center  bg-blue-400 group   active:bg-blue-400  dark:bg-slate-500">
