    ...
    <div className={`${cartItems.length ? "col-span-8" : "col-span-12"} px-4`}>
      ...
      {cartItems.length > 0 ? (
        <div className="gap-4 flex items-center pt-8">
          <input
            type="text"
            className="bg-gray-50 w-64 focus:outline-none border-1 border-gray-300 text-gray-900 text-sm rounded-lg  focus:border-black  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white  py-4"
            placeholder="Enter your coupon code"
            required
          />
          <button className="bg-blue-400 text-gray-900 hover:bg-blue-500 py-4 rounded-lg px-4 duration-300">
            Apply Coupon
          </button>
        </div>
      ) : (
